        ...
        <style>
            ...
            body::before {
                ...
                background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)),
                    url('https://i.pinimg.com/1200x/ad/98/52/ad98528d33b2f21342a6e34956b2de75.jpg') no-repeat center center;
                opacity: 0.2;
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-9  p-3  shadow-sm rounded" id="productsContent">
                    ...
                    <div class="container text-end mb-4">
                        <a href="homenhua" class="btn btn-accent d-inline-flex align-items-center gap-2">
                            Quay về trang home...
