...
%>
    <a href="View/admin.jsp" class="btn btn-warning btn-sm me-2">Admin</a>
    <a class="btn btn-outline-light btn-sm" href="logout">Log out</a>
<% 
    } else {
%>
    <span class="me-2">Xin chào, <%= user.getUsername() %></span>
    <a class="btn btn-outline-light btn-sm" href="logout">Log out</a>
<% 
    }
} else {
%>
    <a href="View/login.jsp" class="btn btn-outline-light btn-sm">Sign In</a>
<% } %>
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="productDetailServlet?id=<%=p.getId()%>">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-9  p-3  shadow-sm rounded" id="productsContent">
                    ...
                    <div class="container text-end mb-4">
                        <a href="sanphamgiay" class="btn btn-accent d-inline-flex align-items-center gap-2">
                            Xem tất cả sản phẩm
        ...
        <div class="sanpham text-center my-4">
            <p>Mô hình giấy chất lượng nhất! Hot!!</p>
        </div> 
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <%
